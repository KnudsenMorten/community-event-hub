...
/// <summary>
/// ISO 3166-1 alpha-2 country list for the speaker country picker. The dropdown shows
/// "DK - Denmark"; the stored/synced value is the 2-letter code ("DK") — that's what
/// goes to Zoho. Sorted by country name.
/// </summary>
public static class Countries
{
    public static readonly IReadOnlyList<(string Code, string Name)> All = new[]
    {
        ...
        ("BL","Saint Barthélemy"),("SH","Saint Helena"),("KN","Saint Kitts and Nevis"),("LC","Saint Lucia"),("MF","Saint Martin (French)"),
        ...
        ("SG","Singapore"),("SX","Sint Maarten (Dutch)"),("SK","Slovakia"),("SI","Slovenia"),("SB","Solomon Islands"),
