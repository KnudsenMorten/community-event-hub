...
/// <summary>
/// SUPERSEDED (§234 UX): the standalone "My shifts" page was merged into the unified
/// <c>/volunteer/myschedule</c> (see <see cref="MyScheduleModel"/>, REQUIREMENTS §20/§21) —
/// the shift confirm / decline / request-swap handlers all live there now. This route only
